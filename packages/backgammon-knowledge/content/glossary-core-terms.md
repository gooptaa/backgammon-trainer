...
summary: Shared definitions for frequent coaching terms so explanations stay consistent across reviews and current-position questions.
...
Anchor: a point you own in the opponent home board that keeps contact and can reduce attack risk.
